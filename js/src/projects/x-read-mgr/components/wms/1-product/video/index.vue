...
import * as services from 'services/x-read/video'
...
.index.clearfix
  .dialogs
    ...
    el-dialog(
      ...
      .content(slot="title")
        Detail(typeDetail='视读' :type="detailDialoaType" :detailData="detailData" @back="detailDialog=false" @change="change" @delete="delVersion" :services="services")
