...
export default {
  ...
  methods: {
    ...mapMutations(['setIsPlayerVideoShow', 'setCurrVideoIndex', 'setVideoPlayList']),
    init() {
      this.query = this.$route.query
    },
    openFirst() {
      this.openVideo(0, this.list[0])
    },
    ...
    .item(v-for="(i,index) in list" )
      ...
      .content
        ...
        .right
          ...
          .fun
            .time
            .price-common.item(@click="$emit('buyItem',i)"  v-if="!isBuyOrFree(i)" )
