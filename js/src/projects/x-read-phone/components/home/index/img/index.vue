...
import * as homeServices from 'reader-api/home'
import * as bookinfoServices from 'reader-api/bookInfo'
import * as bookshelfServices from 'reader-api/bookShelf'
import * as saleServices from 'reader-api/mySale'
import * as dbiServices from 'reader-wms-api/dbi'
import * as servicesAttach from 'reader-api/attach'
