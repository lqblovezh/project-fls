...
export function getList(data = {}) {
    return request_get(restUrl_publish+'/api/audio_product',data);
}
/**
 * 听读产品新增 或者修改  有ID就修改没ID新增
 * @param {Object} data
 ...
 * @param {String} data.attributes.eCommerce.translator_id 译者ID
 * @param {String} data.attributes.eCommerce.subject_terms 主题词
...
export function save({id,...data}) {
    if(id) {
        return request_put(`${restUrl_publish}/api/audio_product/${id}`,data)
    }
    return request_post(restUrl_publish+'/api/audio_product',data)
}
/**
 * 获取听读产品信息
 * @param {Object} data
 * @param {String} data.id - 必有 听读产品id
 */
export function getInfo(data={}){
  let readingListeningInfo = pathToRegexp.compile(restUrl_publish+'/api/audio_product/:id')
  return request_get(readingListeningInfo(data),data)
}
/**
 * 听读产品删除
 * @return {Promise}
...
export function del (data = {}) {
    return request_post(restUrl_publish+'/api/audio_product/delete',data);
}
...
export function urgentDigital(data = {}) {
    return request_put(restUrl_publish+'/api/audio_product/urgent',data);
}
...
export function audits (data = {}) {
    return request_put(restUrl_publish+'/api/audio_product/audits',data)
}
...
export function addGroup (data = {}) {
    return request_post(restUrl_publish+'/api/audio_product/groups',data);
}
...
export function modifyGroup (data = {}) {
  let toPathGroupModify = pathToRegexp.compile(restUrl_publish+'/api/audio_product/:id/groups')
...
export function deleteGroup (data = {}) {
  let toPathGroupDelete=pathToRegexp.compile(restUrl_publish+'/api/audio_product/:id/groups')
...
export function listGroup (data = {}) {
    return request_get(restUrl_publish+'/api/audio_product/groups',data);
}
...
export function moveGroup (data = {}) {
    data.rel_id = data.id;
    delete data.id ;
    return request_put(restUrl_publish+'/api/groups/audio_product',data);
}