...
export function add(data = {}) {
    return request_post(restUrl_publish+'/api/librariess',data).then(result=>{
      const{
        _id,
        name,
        abs,
...
export function modify({id,...data} = {}) {
  let toPath = pathToRegexp.compile(restUrl_publish+'/api/librariess/:id');
...
export function listLibraries(data = {}) {
    return request_get(restUrl_publish+'/api/librariess',data);
}
...
export function educe(data = {}) {
    educeResListener({
      res_url:getFullPath(restUrl_publish+'/api/librariess/export' + qs.stringify(data, {addQueryPrefix: true}))
    })
    return request_get(restUrl_publish+'/api/librariess/export',data)
}
...
export function putin(data = {}) {
  return request_post(restUrl_publish+'/api/librariess/import', data)
}
...
export function deleteLibraries(data = {}) {
    return request_post(restUrl_publish+'/api/librariess/delete',data);
}
...
export function modifyGroup({id,...data} = {}) {
  let toPathGroup = pathToRegexp.compile(restUrl_publish+'/api/librariess/groups/:id');
...
export function deleteGroup(data = {}) {
    return request_post(restUrl_publish+'/api/librariess/groups/delete',data);
}
...
export function addGroup(data = {}) {
    return request_post(restUrl_publish+'/api/librariess/groups',data);
}
...
export function listGroup() {
    return request_get(restUrl_publish+'/api/librariess/groups');
}
...
export function moveGroup(data = {}) {
    return request_put(restUrl_publish+'/api/librariess/groups',data);
}
