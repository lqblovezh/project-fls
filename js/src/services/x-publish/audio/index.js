...
export function add(data = {}) {
    return request_post(restUrl_publish+'/api/audios',data).then(result=>{
        const{
            _id,
            name,
            abs,
...
export function modify({id,...data} = {}) {
  let toPath = pathToRegexp.compile(restUrl_publish+'/api/audios/:id');
...
export function listAudio(data = {}) {
    return request_get(restUrl_publish+'/api/audios',data);
}
...
export function educe(data = {}) {
    educeResListener({
      res_url:getFullPath(restUrl_publish+'/api/audios/export' + qs.stringify(data, {addQueryPrefix: true}))
    })
    return request_get(restUrl_publish+'/api/audios/export',data)
}
...
export function putin(data = {}) {
  return request_post(restUrl_publish+'/api/audios/import', data)
}
...
export function deleteAudio(data = {}) {
    return request_post(restUrl_publish+'/api/audios/delete',data);
}
...
export function modifyGroup({id,...data} = {}) {
  let toPathGroup = pathToRegexp.compile(restUrl_publish+'/api/audios/groups/:id');
...
export function deleteGroup(data = {}) {
    return request_post(restUrl_publish+'/api/audios/groups/delete',data);
}
...
export function addGroup(data = {}) {
    return request_post(restUrl_publish+'/api/audios/groups',data);
}
...
export function listGroup() {
    return request_get(restUrl_publish+'/api/audios/groups');
}
...
export function moveGroup(data = {}) {
    return request_put(restUrl_publish+'/api/audios/groups',data);
}
