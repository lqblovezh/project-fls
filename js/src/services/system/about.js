...
let toPath = pathToRegexp.compile('/system/api/xbooks/:id');

/**
 * xbooks列表
 */
 export function getList(data){
   return request_get("/system/api/xbooks",data)
 }
...
export function save(data){
  ...
  return request_post('/system/api/xbooks',data)
}
...
export function del(data){
  return request_post('/system/api/xbooks/delete',data)
}