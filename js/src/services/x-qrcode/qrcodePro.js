 ...
 * 新增/修改资源配置
 * @param {Object} data
 * @param {String} data.product_id - 必有字段 二维码产品id
 * @param {Array} data.constitute - 必有字段 关联id
 * @param {String} data.constitute.name - 必有字段 资源名称
 * @param {String} data.constitute.resource_id - 必有字段 资源id
 * @param {String} data.constitute.preview - 必有字段 链接地址
 * @param {String} data.constitute.resource_type - 必有字段 资源类型
 */
export function saveProduct(data={}) {
  return request_put('/api/qrcode_product/resource', data)
}
