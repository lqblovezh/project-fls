...
let toPathGroup = pathToRegexp.compile('/api/audio_product/groups/:id');
let toPathGroupModify = pathToRegexp.compile('/api/audio_product/:id/groups');
let bookDetail = pathToRegexp.compile('/api/audio_product/:id')
...
export function getList(data = {}){
  return request_get('/api/audio_product',data)
}
...
export function put(data){
  return request_put('/api/audio_product/put', data)
}
...
export function pull(data){
  return request_put('/api/audio_product/pull', data)
}
...
export function groupList(data={}){
  return request_get('/api/audio_product/groups',data )
}
...
export function group({id,...data}){
  ...
  return request_post('/api/audio_product/groups',data)
}
...
export function groupMove(data){
  return request_put('/api/groups/audio_product', data)
}
 ...
 * @param {String} data.type - 必有字段 类型（book->16 picture->3 audio->4 video->5）
 */
