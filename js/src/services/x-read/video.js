...
let toPathGroup = pathToRegexp.compile('/api/video_product/groups/:id');
let toPathGroupModify = pathToRegexp.compile('/api/video_product/:id/groups');
let bookDetail = pathToRegexp.compile('/api/video_product/:id')
...
export function getList(data = {}){
  return request_get('/api/video_product',data)
}
...
export function put(data){
  return request_put('/api/video_product/put', data)
}
...
export function pull(data){
  return request_put('/api/video_product/pull', data)
}
...
export function groupList(data={}){
  return request_get('/api/video_product/groups',data )
}
...
export function group({id,...data}){
  ...
  return request_post('/api/video_product/groups',data)
}
...
export function groupMove(data){
  return request_put('/api/groups/video_product', data)
}
